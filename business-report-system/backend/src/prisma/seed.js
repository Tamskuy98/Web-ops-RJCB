...
async function main() {
  ...
  await prisma.logTransaction.deleteMany();
  await prisma.sale.deleteMany();
  await prisma.hsale.deleteMany();
  await prisma.deposit.deleteMany();
  await prisma.debt.deleteMany();
  await prisma.paydebt.deleteMany();
  await prisma.opsdetail.deleteMany();
  await prisma.operational.deleteMany();
  await prisma.restockDetail.deleteMany();
  await prisma.restock.deleteMany();
  await prisma.qris.deleteMany();
